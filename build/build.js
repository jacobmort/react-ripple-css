...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ripple = function (_Component) {
	  ...
	  _createClass(Ripple, [{
	    ...
	    value: function componentWillReceiveProps(e) {
	      ...
	      setTimeout(function () {
	        _this2.setState(Object.assign({}, DEFAULT_STATE));
	      }, 950);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var rippleClass = this.state.animating ? "ripple ripple-effect" : "ripple";
	      var maxDimension = Math.max(this.props.containerWidth, this.props.containerWidth);
	      var rippleStyle = {
	      ...
	      return _react2.default.createElement('span', { style: rippleStyle, className: rippleClass });
	    }
	  }]);
	...
	Ripple.propTypes = {
	  containerWidth: _react.PropTypes.number,
	  containerHeight: _react.PropTypes.number,
	  xPos: _react.PropTypes.number,
	  yPos: _react.PropTypes.number,
	  rippleWidth: _react.PropTypes.number,
	  rippleHeight: _react.PropTypes.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ripple-effect {\n  position: absolute;\n  border-radius: 50%;\n  animation: ripple-animation 1s;\n}\n\n@keyframes ripple-animation {\n    from {\n      transform: scale(0);\n      opacity: 0.4;\n    }\n    to {\n      transform: scale(2);\n      opacity: 0;\n    }\n}\n", ""]);
